...
##### Your code to resolveObjectFOPC here -- this takes the root, the primary (subject) and your names
    prepPhrases = core.findAndAttachPrepObjectsFOPC(root, subject, names)
